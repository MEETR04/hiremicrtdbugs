...
class seceondCongratulationScreen extends StatefulWidget {
  seceondCongratulationScreen({super.key});

  @override
  State<seceondCongratulationScreen> createState() =>
      _seceondCongratulationScreenState();
}

class _seceondCongratulationScreenState
    extends State<seceondCongratulationScreen> {
  void initState() {
    super.initState();
  }
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Image.asset(
                      'images/seceondCongratulations.png',
                    ),
