            ...
            child: Container(
              child: Column(
                ...
                children: [
                    ...
                    child: Center(
                      child: CircleAvatar(
                        ...
                        child: (Gender != 'Male' && Gender != 'Female')
                            ? const Center(child: CircularProgressIndicator()) // Show CircularProgressIndicator when gender is neither male nor female
                  ...
                  Text(FullName,style: const TextStyle(fontSize: 25,fontWeight: FontWeight.w700),),
                  Text(loginEmail,style: const TextStyle(
                    fontFamily: 'FontMain',
                  ),),
                  ...
                  ListTile(
                    ...
                    title: const Text('Security',style: TextStyle(color: Color(0xFFBD232B),fontSize: 25, fontFamily: 'FontMain',)),
                  ...
                  ListTile(
                    ...
                    title: const Text('Privacy Policy',style: TextStyle(color:Color(0xFFBD232B),fontSize: 25, fontFamily: 'FontMain',),),
