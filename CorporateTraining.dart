...
class _CorporateTrainingState extends State<CorporateTraining> {
  ...
  Future<void> AlreadyApplied() async {
    try {
      final response =
          await http.get(Uri.parse('${ApiUrls.baseurl}api/corporatetraining/'));
            ...
            child: SafeArea(
              child: Column(
                children: [
                        ...
                        text: TextSpan(
                          ...
                          children: const [
                            ...
                            TextSpan(
                              ...
                              style: TextStyle(
                                color: Colors
                                    .redAccent, // Red color for "Corporate Training"
                              ),
                            ),
                            TextSpan(
                              text: "?",
                  ...
                  Text(
                    "Corporate training program at Hiremi prioritise comprehensive learning, diversity, and career excellence. We offer hands-on expertise, practical exercises, and a structured curriculum, preparing individuals for real-world challenges in a shorter time frame.",
                    textAlign: TextAlign.center,
                    style: TextStyle(
                  ...
                  Padding(
                    ...
                    child: Stack(
                      children: [
                        Container(
                          width:
                              screenWidth * 0.75, // Adjust the width as needed
                          height: screenHeight *
                              0.39, // Adjust the height as needed
                          child: Card(
                              elevation: 9.0,
                              surfaceTintColor:
                                    ...
                                    child: RichText(
                                      ...
                                      text: TextSpan(
                                        ...
                                        children: const [
                                          ...
                                          TextSpan(
                                            text:
                                                "/250,000", // This will remain unstruck
                                            style: TextStyle(
                                              decoration:
                        ...
                        Padding(
                          padding:
                              const EdgeInsets.only(left: 220.0, bottom: 70),
                          child: Card(
                              elevation: 9.0,
                              surfaceTintColor:
                                  Colors.transparent, // rgba(0, 0, 0, 0.25)
                  ...
                  Text(
                    " Unlock your potential with Hiremi – where Corporate Training meets tailored guidance for your journey to success.",
                    textAlign: TextAlign.center,
                    style: TextStyle(
                        fontWeight: FontWeight.w600,
